      ...
      <div className="container-custom">
        <div className={`mb-12 pb-6 border-b flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 transition-colors duration-700 ${borderColor}`}>
          <div className="flex items-center gap-3">
            ...
            <h2 className={`text-2xl md:text-3xl font-bold uppercase tracking-tight transition-colors duration-700 ${textColor}`}>Leistungen</h2>
          </div>
          <Link href="/leistungen">
            <a className={`text-xs uppercase tracking-widest hover:text-[#eedea0] transition-colors ${mutedColor}`}>
              Alle ansehen
            </a>
          </Link>
        </div>
